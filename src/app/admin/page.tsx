...
export default async function AdminDashboard() {
  ...
  const [statsResult, activityResult, activeUsersResult, growthResult, cbtStatsResult] = await Promise.all([
    getPlatformStats(),
  ...
  const cbtStats = cbtStatsResult.success ? cbtStatsResult.data : null
  ...
  return (
    <div className="p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {cbtStats && (
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">CBT (Continuous Assessment Testing)</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <StatsCard
                title="Total Bundles"
                value={cbtStats.totalBundles || 0}
                description="Active subscription bundles"
                icon={BookOpen}
                iconColor="text-blue-500"
              />
              ...
              <StatsCard
                ...
                value={cbtStats.activeSubscriptions || 0}
                description={`of ${cbtStats.totalSubscriptions || 0} total`}
                icon={Zap}
                iconColor="text-green-500"
              />
              ...
              <StatsCard
                title="CBT Revenue"
                value={`₦${(cbtStats.totalCBTRevenue || 0).toLocaleString()}`}
              ...
              <StatsCard
                title="CBT Students"
                value={cbtStats.uniqueStudents || 0}
                description={`${cbtStats.cbtCourses || 0} courses available`}
                icon={Users}
                iconColor="text-purple-500"
              />
            </div>
