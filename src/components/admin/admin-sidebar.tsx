...
const navigation = [
  ...
  },
  {
    ...
    icon: Building2,
    submenu: [
      { name: 'All Institutions', href: '/admin/institutions' },
      { name: 'Create Admin', href: '/admin/institutions/create-admin' },
    ],
  },
  {
    name: 'Finances',
  ...
  },
  {
    ...
    icon: BookOpen,
    submenu: [
      { name: 'Dashboard', href: '/admin/cbt' },
      { name: 'Courses', href: '/admin/cbt/courses' },
      { name: 'Bundles', href: '/admin/cbt/bundles' },
...
const SidebarShell = ({ children }: { children: React.ReactNode }) => (
  <div className="flex flex-col h-full">
    ...
    <div className="px-6 py-4 border-t border-border-gray flex-shrink-0">
      <p className="text-xs text-text-gray text-center">Assessify Admin v1.0</p>
    </div>
  </div>
)
...
export function AdminSidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed top-0 left-0 h-screen w-64 bg-white border-r border-border-gray z-40 transform transition-transform duration-300 ease-in-out overflow-y-auto lg:hidden',
