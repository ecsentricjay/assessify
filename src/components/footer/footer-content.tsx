...
const SOCIAL_LINKS = [
  {
    name: 'Facebook',
    icon: Facebook,
    href: 'https://facebook.com/assessifyapp',
    color: 'hover:text-[#1877F2]',
  },
  {
    name: 'Instagram',
    icon: Instagram,
    href: 'https://instagram.com/assessifyapp',
...
export function FooterContent({ userType, className }: FooterContentProps) {
  ...
  return (
    <footer className={cn('bg-white border-t border-[#E5E7EB] relative z-10', className)}>
      {/* Main Footer */}
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 group">
                <div className="w-10 h-10 rounded-lg bg-[#EFF6FF] flex items-center justify-center shrink-0 group-hover:bg-[#DBEAFE] transition-colors">
